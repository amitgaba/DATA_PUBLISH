sap.ui.define([
		...
		return BaseObject.extend("da.sql.publish.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias da.sql.publish.model.ListSelector
			 */
			 ...
			 * @return {da.sql.publish.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
