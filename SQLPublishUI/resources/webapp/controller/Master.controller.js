...
sap.ui.define([
		...
		return BaseController.extend("da.sql.publish.controller.Master", {
		...
		_getDialog: function() {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("da.sql.publish.view.createEntry", this);
		...
		onSave: function() {
			...
			var url = "/SaveSQLData.xsjs";


			var functional = sap.ui.getCore().getElementById('function').getValue();
			var sqlcode = sap.ui.getCore().getElementById('SQLCode').getValue();
			...
			var OutCols = sap.ui.getCore().getElementById('Outcols').getValue();
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("S_CODE", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("da.sql.publish.view.ViewSettingsDialog", this);
