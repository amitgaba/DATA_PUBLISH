sap.ui.define([
	...
	return BaseObject.extend("da.sql.publish.model.GroupSortState", {
		 ...
		 * @alias da.sql.publish.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "ID") {
				...
				this._oViewModel.setProperty("/sortBy", "S_CODE");
			}
