sap.ui.define([
	...
	return BaseObject.extend("da.publish.model.GroupSortState", {
		 ...
		 * @alias da.publish.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "ID") {
				...
				this._oViewModel.setProperty("/sortBy", "VIEW_NAME");
			}
