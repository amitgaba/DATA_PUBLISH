...
sap.ui.define([
		...
		"da/publish/model/grouper",
		"da/publish/model/GroupSortState"
		...
		return BaseController.extend("da.publish.controller.Master", {
		...
		onUpload: function(oEvent) {
			...
			this._getUploadDialog().setModel(userModel, "userapi");
		...
		_getUploadDialog: function() {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("da.publish.view.UploadCSV", this);
		...
		_getDialog: function() {
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("da.publish.view.createEntry", this);
		...
		onSave: function() {
			...
			var tfolder = sap.ui.getCore().getElementById('Tfolder').getValue();
			var tfile = sap.ui.getCore().getElementById('TFile').getValue();
			var schedule = sap.ui.getCore().getElementById('Schedule').getValue();
			var filter = sap.ui.getCore().getElementById('Filter').getValue();
			var OutCol = sap.ui.getCore().getElementById('OutCol').getValue();
			var PlHold = sap.ui.getCore().getElementById('PlHold').getValue();
			var SchID = sap.ui.getCore().getElementById('SCHID').getValue();
			var ToAccess;
			if (sap.ui.getCore().getElementById('TOACCESS').mProperties.selected) {
				ToAccess = 'X';
				} 
				else {
					ToAccess = "";
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("VIEW_NAME", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("da.publish.view.ViewSettingsDialog", this);
