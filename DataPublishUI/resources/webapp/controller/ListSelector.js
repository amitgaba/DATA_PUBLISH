sap.ui.define([
		...
		return BaseObject.extend("da.publish.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias da.publish.model.ListSelector
			 */
			 ...
			 * @return {da.publish.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
